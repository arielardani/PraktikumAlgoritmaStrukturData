...
public class BinaryTreeArrayMain04 {
    public static void main(String[] args) {
        ...
        bta.add(new Mahasiswa04("2442", "Someone1", "A", 3.58));
        bta.add(new Mahasiswa04("2441", "Someone2", "C", 3.43));
        bta.add(new Mahasiswa04("2443", "Someone3", "B", 3.76));
        
        System.out.println("Traversal PreOrder:");
        bta.traversePreOrder(0);
        
        bta.add(new Mahasiswa04("2444", "Someone4", "B", 3.79));
